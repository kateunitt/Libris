...
public class MainActivity extends AppCompatActivity
    ...
    Button buttonOwnedFiction, buttonNeedFiction, buttonWishListFiction, buttonBorrowedFiction, buttonSellFiction,
            buttonOwnedNonFiction, buttonNeedNonFiction, buttonWishListNonFiction, buttonBorrowedNonFiction,
            buttonSellNonFiction, buttonBorrowedFromWGU, buttonBorrowedFromWCBC, buttonBorrowedFromCC;
    ...
    public void SetupControls(){
        ...
        //Buttons leading to Activities displaying Fiction Books
        buttonOwnedFiction =(Button)findViewById(R.id.buttonOwnedFiction);
        buttonOwnedFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        buttonNeedFiction =(Button)findViewById(R.id.buttonNeedFiction);
        buttonNeedFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonWishListFiction =(Button)findViewById(R.id.buttonWishListFiction);
        buttonWishListFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonBorrowedFiction =(Button)findViewById(R.id.buttonBorrowedFiction);
        buttonBorrowedFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonSellFiction =(Button)findViewById(R.id.buttonSellFiction);
        buttonSellFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        //Buttons leading to Activities displaying Non-Fiction books
        buttonOwnedNonFiction =(Button)findViewById(R.id.buttonOwnedNonFiction);
        buttonOwnedNonFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonNeedNonFiction =(Button)findViewById(R.id.buttonNeedNonFiction);
        buttonNeedNonFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonWishListNonFiction =(Button)findViewById(R.id.buttonWishListNonFiction);
        buttonWishListNonFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonBorrowedNonFiction =(Button)findViewById(R.id.buttonBorrowedNonFiction);
        buttonBorrowedNonFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonSellNonFiction =(Button)findViewById(R.id.buttonSellNonFiction);
        buttonSellNonFiction.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        // Buttons leading to Activities displaying Borrowed Books
        buttonBorrowedFromWGU =(Button)findViewById(R.id.buttonBorrowedFromWGU);
        buttonBorrowedFromWGU.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonBorrowedFromWCBC =(Button)findViewById(R.id.buttonBorrowedFromWCBC);
        buttonBorrowedFromWCBC.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        buttonBorrowedFromCC =(Button)findViewById(R.id.buttonBorrowedFromCC);
        buttonBorrowedFromCC.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
